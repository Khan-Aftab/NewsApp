...
public class SkyNewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webViewSkyNews = view.findViewById(R.id.webViewSkyNews);
        webViewSkyNews.loadUrl("https://news.sky.com/");
        webViewSkyNews.setWebViewClient(new WebViewClient());
