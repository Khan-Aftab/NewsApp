...
public class AlJazeeraFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webViewAlJazeera = view.findViewById(R.id.webViewAlJazeera);
        webViewAlJazeera.loadUrl("https://www.aljazeera.com/");
        webViewAlJazeera.setWebViewClient(new WebViewClient());
